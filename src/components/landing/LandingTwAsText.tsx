            ...
            <body>
              ...
              >
                ...
                >
                  ...
                  <div
                    class="grid shadow-2xl mx-auto mt-6 overflow-hidden leading-7 text-gray-900 rounded-xl md:max-w-lg lg:max-w-none sm:mt-10 lg:grid-cols-3"
                  >
                    <div
                      class="box-border px-4 py-8 mb-6 text-center bg-white border-solid
                     lg:mb-0 sm:px-4 sm:py-8 md:px-8 md:py-12 lg:px-10"
                    >
                      <h3
                    ...
                    <div
                      class="box-border px-4 py-8 mb-6 text-center bg-gray-100lg:mb-0 sm:px-4 sm:py-8 md:px-8 md:py-12 lg:px-10"
                    >
                      <h3
                        class="m-0 text-2xl font-semibold leading-tight tracking-tight text-black border-0 border-solid sm:text-3xl md:text-4xl"
                      >
...
export default LandingTwAsText